...
export default function BottomAppBar() {
    return (
        <React.Fragment>
            ...
            <Box sx={{ flexGrow: 1 }}>
                <CssBaseline />
                <AppBar color="transparent" elevation={0} position="absolute" align='center' sx={{ top: 'auto', bottom: 0 ,zIndex:1}} style={{ backgroundImage: `url(${backgroundEnd})`, backgroundSize: "fixed", backgroundRepeat: 'no-repeat', backgroundAttachment: 'cover', heigth: "15vh" }}>
                    <Grid
                        container
                        direction="row"
