...
export default class TournamentLobby extends Component {
    ...
    render() {
        ...
        return (
            <Box sx={{ flexGrow: 1 }}>
                <Grid container height="93vh" style={{ backgroundImage: `url(${backgroundEnd})`, backgroundSize: 'auto auto', backgroundAttachment: 'fixed' }}>
                    <Grid xs={12}  >
                        <React.Fragment>
                            <Box sx={{ flexGrow: 1, }}>
                                <CssBaseline />
                    ...
                    >
                        ...
                        <Grid item xs={4.5} height="9vh" style={{ border: "1px solid grey", textAlign: 'center' }} >
                            ...
                            <Typography variant="h6">{BattleMode[this.props.match.params.entryid].entryFee}
